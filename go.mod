module cadence_arch/overflowV2
...
require (
	...
	github.com/bjartek/overflow/v2 v2.0.0-stable-cadence-beta.22 // indirect
	...
	github.com/onflow/flowkit/v2 v2.0.0-stable-cadence-alpha.33 // indirect
